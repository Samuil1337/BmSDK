...
If you have a Steam or GOG copy of the game, you'll have to install a compatibility patch. You can download it [here](https://github.com/user-attachments/files/29343051/CompatibilityPatch.zip).
Just replace the `BatmanAC.exe` from your game folder (see above) with the one provided. It's a good idea to make a backup first.
